    ...
    <header className="fixed top-0 left-0 z-50 w-full bg-white">
      <div className="w-full max-w-432 px-5 py-2.5 tablet:px-10 desktop:px-15 desktop:py-7.5 mx-auto">
        <div className="flex items-center justify-between">
          <a href="/" aria-label="На главную" className="font-roboto text-2xl uppercase leading-9 -tracking-2 tablet:text-3xl tablet:leading-11.25 desktop:text-4xl desktop:leading-13.5">Логотип</a>
          <div className="flex w-fit items-center justify-between gap-x-5 desktop:gap-x-[3.9rem]">
            <nav aria-label="Основная навигация" className="hidden tablet:flex mt-0.5">
